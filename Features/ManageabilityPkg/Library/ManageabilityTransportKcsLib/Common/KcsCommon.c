...
extern MANAGEABILITY_TRANSPORT_KCS_HARDWARE_INFO mKcsHarwareInfo;
  ...
  )
{
  ...
  if (mKcsHarwareInfo.MemoryMap == MANAGEABILITY_TRANSPORT_KCS_MEMORY_MAP_IO) {
