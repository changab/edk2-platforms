...
#define KCS_BASE_ADDRESS     mKcsHarwareInfo.IoBaseAddresss
#define KCS_REG_DATA_IN      mKcsHarwareInfo.IoDataInAddress
#define KCS_REG_DATA_OUT     mKcsHarwareInfo.IoDataOutAddress
#define KCS_REG_COMMAND      mKcsHarwareInfo.IoCommandAddress
#define KCS_REG_STATUS       mKcsHarwareInfo.IoStatusAddress
