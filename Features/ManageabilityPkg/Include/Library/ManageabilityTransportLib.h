...
#define MANAGEABILITY_TRASNPORT_TOKEN_VERSION_MAJOR  1
#define MANAGEABILITY_TRASNPORT_TOKEN_VERSION_MINOR  0
#define MANAGEABILITY_TRASNPORT_TOKEN_VERSION ((MANAGEABILITY_TRASNPORT_TOKEN_VERSION_MAJOR << 8) | \
                                                MANAGEABILITY_TRASNPORT_TOKEN_VERSION_MINOR)
...
///
/// Definitions of Managebility transport interface functions.
...
///
/// Definitions of Managebility transport interface.
///
struct _MANAGEABILITY_TRANSPORT {
  ...
  UINT16                            TransportVersion;                     ///< The version of transport interface
                                                                          ...
                                                                          ///< is upported by this library.
  CHAR16                            *TransportName;                       ///< Human readable string of
                                                                          ///< this transport interface.
  MANAGEABILITY_TRANSPORT_FUNCTION  Fucntion;                             ///< Transport functions
};

///
/// Definitions of Managebility transport token.
///
...
/// the response from transport interface after transmiting the
/// request.
///
struct _MANAGEABILITY_TRANSFER_TOKEN {
  ...
  MANAGEABILITY_TRANSPORT_HEADER                TransmitHeader;       ///< This is the transport-specific header
                                                                      ...
                                                                      ///< Theis field can be NULL if the transport
...
/**
  ...
  @param [in]  HardwareInfo             This is the optional hardware information
                                        assigend to this transport interface.
